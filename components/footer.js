...
function Footer() {
  return (
    <footer className="max-w-screen-xl mx-auto py-16 px-4 overflow-hidden sm:px-6 lg:px-8">
      <nav className="-mx-5 -my-2 flex flex-wrap justify-center">
        <div className="py-2 px-5">
          <a href="#" className="text-base leading-6 text-cool-gray-500 hover:text-cool-gray-900">
            About
          </a>
        </div>
        <div className="py-2 px-5">
      ...
      <div className="mt-8 flex justify-center space-x-6">
        <a href="#" className="text-cool-gray-400 hover:text-cool-gray-500">
      ...
      <p className="mt-8 text-center text-base leading-6 text-cool-gray-500">
